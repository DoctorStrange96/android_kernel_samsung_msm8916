...
function RaijinAsciiArt {
	...
	sleep 0.1;
	echo -e " Special build for AetherLite ROM by CaelestisZ  ";
	sleep 0.1;
	echo -e " Version: $KernelVersion                        ";
	sleep 0.1;
	echo -e " Based on ZIM555's sources 					 ";
	sleep 0.1;
	echo -e " Made for Samsung Galaxy Grand Prime (SM-G530)   ";
	sleep 0.1;
	echo -e " Compatible with Android 7.x (Nougat) SE ROMs    ";
	sleep 0.1;	
	echo -e "";
	sleep 0.1;
...
function InitialSetup {
	...
	export ARCH="arm";
	export SUBARCH="arm";
	export CROSS_COMPILE=~/Toolchains/AOSP-4.8-arm-eabi/bin/arm-eabi-;

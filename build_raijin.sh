...
You'll find your flashable zip at raijin/final_builds/$SelectedDevice.";
		...
		echo -e "Build failed. Kernel image not found. Check the source code for errors, then try again.";
		exit 1;
	fi;
};
...
for help.";
	...
	*)
		...
		case $1 in
			...
			"a" | "all" | "ba" | "buildall")
				BuildForAll="true";
				echo -e "Building for all devices sequentially. This will take a long time.";
